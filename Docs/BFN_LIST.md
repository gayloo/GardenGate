...
- StartPoint_Suburbination
- StartPoint_GnomeBomb
- StartPoint_Coop_Ops_GardenA
...
|------------------------|----------------------------------|
| Garden Ops             | StartPoint_Coop_Ops_GardenA      |
| Graveyard Ops          | StartPoint_Coop_Ops_GraveyardA   |
| Turf Takeover          | StartPoint_Rush                  |
| Battle Arena           | StartPoint_TeamElimination       |
| Team Vanquish          | StartPoint_TVM                   |
| Vanquish Confirmed     | StartPoint_VanquishConfirmed     |
| Suburbination          | StartPoint_Suburbination         |
| Gnome Bomb             | StartPoint_GnomeBomb             |
| Social Space           | StartPoint_SocialSpace           |
